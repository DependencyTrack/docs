...
1. Open *Projects* and select *Create Project*, or open an existing project and select *View Details*.
...
1. Toggle *Collection project* on. The *Classifier* field disappears. Collection projects
   have no classifier.
2. Choose a *Project Collection Logic* (see [Choose a collection logic](#choose-a-collection-logic)).
...
![Create collection project](../../assets/images/guides/user/organizing-projects/create-collection-project.png)
...
In the dropdown, pick *Aggregate direct children*. This mode rolls up every direct child,
...
In the dropdown, pick *Aggregate direct children with tag* and fill in the *Collection tag*
...
![Create collection project](../../assets/images/guides/user/organizing-projects/collection-with-tag.png)

### Roll up the latest version of each child

In the dropdown, pick *Aggregate latest version children*. The aggregation rolls up only
...
- **Service, version.** A collection-project parent per service using the latest-version
  mode, with a regular child per version. Cloning a new version with *Is latest version*
